...
public class Maker {
	...
	protected String cleaned_esdb, cleaned_fd, cleaned_fd_div, fd_div, cleaned_td, cleaned_atpmt, cleaned_atpmds, cleaned_path, cleaned_countries, cleaned_cities, pf_syn_file, pf_syn_team_file;
	protected HashMap<String,String> pf_syn_map, pf_syn_team_map;
